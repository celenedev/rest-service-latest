...
CREATE TABLE DENOMINATION (
                              DENOMINATION_ID        INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ATM (
                     ATM_ID   INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ATM_ALLOCATION (
                                ATM_ALLOCATION_ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
